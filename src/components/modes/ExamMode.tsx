    ...
    return (
      <div>
        ...
        <div className="text-center mt-12">
          ...
          <h2 className="text-white font-mono text-2xl font-bold mb-2">
            Mock Exam
          </h2>
          <p className="text-gray-600 text-sm mb-1">
            {cert.name} &bull; {Math.min(50, allMC.length)} questions &bull; 60
            minutes
          </p>
          {allMC.length < 10 && (
            <p className="text-accent-pink text-xs mb-4">
              ⚠ Only {allMC.length} questions available — expand the question
              bank for a full exam
            </p>
          )}
          <button
            onClick={startExam}
      ...
      <div>
        ...
        <div className="text-center mt-8 mb-8">
          ...
          <div className="text-gray-700 text-[13px] mt-2 font-mono">
            {score}/{questions.length} correct &bull;{" "}
            {formatTime(3600 - timeLeft)} elapsed
          </div>
        </div>
